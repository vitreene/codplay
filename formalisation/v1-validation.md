...
- `initialStoryId` absent/invalide -> `AUTHOR_INITIAL_STORY_INVALID`
...
4. compiler `CompiledScene` (`schemaVersion`, `createdAt`, `tracks`, `topLevelStories`, `initialStoryId`)
5. executer un run de smoke runtime avec collecte erreurs/warnings

## Regle d'extension

- tout nouveau code d'erreur/warning V1 est ajoute dans `48-error-catalog-v1.md`
