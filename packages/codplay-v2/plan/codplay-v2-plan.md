...
| Tiers, modules et services | Binding tiers, preload, adapter hub, dispatcher generique, catalogues et ModuleServices player-scoped | `RuntimeModuleServiceCatalog` et cycle de vie des instances en place; routage des deltas, seek reconciliation et derivation des requirements restent a ouvrir. |
