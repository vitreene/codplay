...
const NATIVE_MOOD_BASELINES: Record<string, MoodBaseline> = {
  neutral: {
    eyesLookDown: 0.1,
  },
  happy: {
...
/** Merges external semantic mood baselines while preserving native Avatar values. */
function createMoodBaselines(): Record<MoodName, MoodBaseline> {
  ...
  return {
    ...external,
    ...NATIVE_MOOD_BASELINES,
  } as Record<MoodName, MoodBaseline>
}

/** Baselines available to the avatar-mood component. */
