...
builder converts the path once into the JSON-safe `Path` object defined by ACE,
using the fixed arc-length traversal and affine visual-center convention. The
