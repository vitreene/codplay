...
- [`../`](../) — le moteur officiel V2. La plupart de ces documents forment le **cahier des charges
...
recommandations. Le plan operatoire de CodPlay V2 est dans `packages/codplay/plan/`.
...
force obligatoire sont au §11 de `notes/2026-07-26-conduite-chantier-v2.md`. Qu'un seul cède,
...
D'où une nuance à ne pas manquer : `notes/2026-07-26-conduite-chantier-v2.md` §10 #4 décide de
...
**Par où entrer** : [`notes/2026-07-28-carte-projet-v2.md`](./notes/2026-07-28-carte-projet-v2.md)
