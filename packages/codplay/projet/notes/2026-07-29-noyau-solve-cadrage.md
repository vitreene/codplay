...
| **Statut** | **Noyau préparatoire de CodPlay V2.** Il vit dans `packages/codplay/src/ace`, se pilote par ses tests et son contrat propre, et ne touche jamais au runtime V1. |
