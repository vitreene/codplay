...
| Capture | La [session player](../../src/runtime/player/runtime-player/capture-controller.ts) et ses [actions live](../../src/runtime/player/live-actions/) réutilisent les déclarations compilées ; les sources navigateur raccordent les événements d’ouverture et de fin au routage `visibility` du pipeline partagé. Le contrat est vérifié ; l'acceptance navigateur S5 et le Seek S6 restent aux plans. | [spécification](../../specs/capture-v2-spec.md), [plan S5](../../plan/capture-s5-validation-plan.md), [plan S6](../../plan/drag-capture-list-s6-validation-plan.md), [test de session](../../tests/runtime/capture/runtime-capture-session.spec.ts), [test runner S6](../../tests/runtime/runner-html/player-runner.spec.ts) |
