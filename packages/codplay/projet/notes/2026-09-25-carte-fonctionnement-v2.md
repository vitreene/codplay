...
| Capture | La [session player](../../src/runtime/player/runtime-player/capture-controller.ts) et ses [actions live](../../src/runtime/player/live-actions/) réutilisent les déclarations compilées ; les sources navigateur se raccordent par l'adaptateur HTML. La migration des sorties `cascade` vers `visibility` reste à appliquer et valider sur les parcours capture S5 et DnD/capture S6. | [spécification](../../specs/capture-v2-spec.md), [plan core capture](../../plan/capture-authoring-plan.md), [plan S5](../../plan/capture-s5-validation-plan.md), [plan S6](../../plan/drag-capture-list-s6-validation-plan.md), [test de session](../../tests/runtime/capture/runtime-capture-session.spec.ts) |
| Scroll et observation | Le [module optionnel](../../../authoring/component-v2/src/scroll-container/scroll-container-module.ts) reste neutre quant au DOM ; sa [factory HTML](../../../authoring/component-v2/src/scroll-container/scroll-container-source-adapter.ts) lit le scrollport par identité et utilise les ports bornés `emit`, capture et actions live du [runner](../../src/runtime/runner-html/source-adapter.ts). Le catalogue core n'enregistre pas ce composant par défaut. | [spécification scroll](../../specs/scroll-container-spec.md), [tests providers](../../../authoring/component-v2/tests/scroll-container-providers.spec.ts), [démo](../../../demos/src/v2/demos/scroll-container/main.ts) |
