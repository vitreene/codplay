...
- `packages/codplay-v1/src/runtime/components/lib/base-component.ts` ;
- `packages/codplay-v1/src/runtime/components/lib/component-services.ts` ;
- `packages/codplay-v1/src/runtime/components/polygon-component.ts` ;
- `packages/codplay-v1/src/runtime/components/lib/anime-svg-service.ts` ;
- `packages/codplay-v1/src/runtime/components/layout-component.ts` ;
- `packages/codplay-v1/src/runtime/components/runtime-component-orchestrator.ts` ;
- `packages/codplay-v1/src/runtime/components/types.ts` ;
- `packages/codplay-v1/tests/v1/polygon-component.spec.ts` ;
- `packages/codplay-v1/tests/v1/layout-runtime.spec.ts` ;
- `packages/codplay-v1/tests/v1/seek-layout-outlet.spec.ts` ;
- `packages/codplay-v1/tests/v1/component-service-operations.spec.ts`.
