...
| Replace | Module de remplacement, clones transitoires et exposition de contenu foreign | [`foreign-scene-component-plan.md`](./foreign-scene-component-plan.md) reprend le contrat V1 `replace-simple` et fixe la transposition V2 du module partagé ; l’implémentation et la validation runtime restent à construire. |
