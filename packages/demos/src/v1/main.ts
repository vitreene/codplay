...
switch (demoName) {
	...
	case 'rive-coach':
		...
		break;
	case 'threejs-anime-grid':
		void runThreejsAnimeGridDemo();
		break;
	case 'mashup-rive-three-quiz':
		void runMashupRiveThreeQuizDemo();
		break;
	case 'mashup-back-and-fore':
		void runMashupBackAndForeDemo();
		break;
	case 'chrono':
		void runChronoDemo();
		break;
	case 'overlay-world-outlet':
		void runOverlayWorldOutletDemo();
		break;
	case 'polygon':
		void runPolygonDemo();
		break;
	case 'quiz-hunt':
		void runQuizHuntDemo();
		break;
	case 'space-bubbles':
		void runSpaceBubblesDemo();
		break;
	case 'stroke-path':
		void runStrokePathDemo();
		break;
	default:
