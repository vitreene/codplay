...
export function createSpaceBubblesScene(): SceneDoc {
  return {
    ...
    listen: [
      ...
      { on: "space:keyboard:left", straps: ["space-bubbles-keyboard-left"] },
      { on: "space:keyboard:right", straps: ["space-bubbles-keyboard-right"] },
      { on: "space:keyboard:left:start", straps: ["space-bubbles-keyboard-left-start"] },
      { on: "space:keyboard:right:start", straps: ["space-bubbles-keyboard-right-start"] },
      { on: "space:keyboard:step", straps: ["space-bubbles-keyboard-step"] },
      { on: "space:keyboard:stop", straps: ["space-bubbles-keyboard-stop"] },
