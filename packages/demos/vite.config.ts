...
export default defineConfig({
  ...
  resolve: {
    alias: [
      ...
      { find: /^@codplay\/avatar-engine\/(.*)/, replacement: resolve(__dirname, '../authoring/avatar-engine/src/$1') },
      { find: '@codplay/avatar-engine', replacement: resolve(__dirname, '../authoring/avatar-engine/src/index.ts') },
