export const eddySnapshotProducedLiteral = {
  persos: [
    {
      type: 'VIDEO',
      initial: {
  ...
  eventtimes: new Map([
    [0, [{ name: 'intro', start: 0 }]],
    [
      460,
      [
        { name: '__auto_capsule_3_item_5_intro_460-intro', start: 460 },
        { name: '3-003-donc-intro', start: 460 },
        { name: '__auto_maximal__maximal_capsule_3_item_89_intro_460-intro', start: 460 }
      ]
    ],
    [640, [{ name: '3-004-vu-intro', start: 640 }]],
    [960, [{ name: '3-007-prsente-custom-1__tween', start: 960 }]],
    [1180, [{ name: '3-005-l-intro', start: 1180 }]],
    [1800, [{ name: '3-007-prsente-custom-1', start: 1800 }]],
    [2020, [{ name: '3-007-prsente-custom-1', start: 2020 }]],
    [
      2440,
      [
        { name: '3-009-risques-intro', start: 2440 },
        { name: '3-008-des-outro', start: 2440 }
      ]
    ],
    [2840, [{ name: '3-009-risques-outro', start: 2840 }]],
    [4780, [{ name: '3-014-risques-outro', start: 4780 }]],
    [5420, [{ name: '3-017-les-outro', start: 5420 }]],
    [5820, [{ name: '3-018-prvenir-outro', start: 5820 }]],
    [6620, [{ name: '3-020-est-outro', start: 6620 }]],
    [16800, [{ name: 'outro', start: 16800 }]],
    [17300, [{ name: '__scene_end__', start: 17300 }]]
  ])
}
